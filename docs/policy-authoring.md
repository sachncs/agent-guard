...
The standalone file watcher observes Cedar files recursively under `policies/`
and `schema.cedarschema`, builds a complete replacement authorizer, and swaps
it only after parsing succeeds. Malformed edits leave the last known-good policy
