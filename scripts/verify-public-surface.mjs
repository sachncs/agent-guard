...
requireText("site/src/pages/docs/reference.astro", "agentguard_core/index.html");
requireText("site/src/pages/docs/reference.astro", "PUBLIC_AGENTGUARD_RUSTDOC");
requireText("scripts/stage-rustdoc.mjs", "agentguard_server");
